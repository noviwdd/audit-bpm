                    ...
                    @if (request()->edit_id == $item->id)
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-400 p-2">
                                ...
                                @else
                                    {{ $item->work_planning }}
                                    <input type="hidden" name="work_planning" value="{{ $item->work_planning }}">
                                @endif
                            </td>
                            ...
                            <td class="border border-gray-400 p-2">
                                ...
                                @else
                                    {{ $item->achieve }}
                                    <input type="hidden" name="achieve" value="{{ $item->achieve }}">
                                @endif
                            </td>
                            ...
                            <td class="border border-gray-400 p-2">
                                ...
                                @else
                                    {{ $item->time_target }}
                                    <input type="hidden" name="time_target" value="{{ $item->time_target }}">
                                @endif
                            </td>
