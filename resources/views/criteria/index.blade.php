...
@section('content')
    <div class="flex flex-row justify-between items-center pb-3">
        <p class="text-xl font-bold text-gray-600 whitespace-nowrap">Daftar Kriteria</p>
        <button
            ...
            data-modal-target="criteria-modal" data-modal-toggle="criteria-modal" onclick="openModal('add')">
            <p>Tambah Kriteria</p>
        </button>
    </div>

    <div class="bg-white p-4 mt-3 rounded-lg shadow overflow-x-auto">
        <table id="criteria" class="">
            <thead class="">
                <tr>
    ...
    <div id="criteria-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="criteria-modal">
                ...
                <div class="p-4 md:p-5">
                    <form id="criteria-form" class="space-y-4" method="POST">
                        @csrf
                        <div>
