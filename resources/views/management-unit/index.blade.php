...
@section('content')
    <div class="flex flex-row justify-between items-center pb-3">
        <p class="text-xl font-bold text-gray-600 whitespace-nowrap">Daftar Unit</p>
        <button
            ...
            data-modal-target="unit-modal" data-modal-toggle="unit-modal" onclick="openModal('add')">
            <p>Tambah Unit</p>
        </button>
    </div>
    ...
    <div id="unit-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form id="unit-form" class="space-y-4" action="" method="POST">
                        @csrf
                        <div>
    ...
    @include('management-unit.script')
@endsection
